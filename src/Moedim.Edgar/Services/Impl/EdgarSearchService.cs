...
namespace Moedim.Edgar.Filings
{
    ...
    /// </summary>
    public class EdgarSearchService : IEdgarSearchService
    {
        private readonly ISecEdgarClient _client;
        private readonly ILogger<EdgarSearchService>? _logger;

        public EdgarSearchService(ISecEdgarClient client, ILogger<EdgarSearchService>? logger = null)
        {
