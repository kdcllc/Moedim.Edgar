...
namespace Moedim.Edgar.Filings
{
    ...
    /// </summary>
    public class EdgarLatestFilingsService : IEdgarLatestFilingsService
    {
        private readonly ISecEdgarClient _client;
        private readonly ILogger<EdgarLatestFilingsService>? _logger;

        public EdgarLatestFilingsService(ISecEdgarClient client, ILogger<EdgarLatestFilingsService>? logger = null)
        {
